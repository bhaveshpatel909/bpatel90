...
<body>
    ...
    <script src="{{asset('assets/jquery/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/jquery/app-style-switcher.js')}}"></script>
    <!--Wave Effects -->
    <script src="{{asset('assets/jquery/waves.js')}}"></script>
    <!--Menu sidebar -->
    <script src="{{asset('assets/jquery/sidebarmenu.js')}}"></script>
    <!--Custom JavaScript -->
    <script src="{{asset('assets/jquery/custom.js')}}"></script>
    <!--This page JavaScript -->
    <!--flot chart-->
    <script src="{{asset('assets/jquery/jquery.flot.js')}}"></script>
    <script src="{{asset('assets/jquery/jquery.flot.tooltip.min.js')}}"></script>
    <script src="{{asset('assets/jquery/dashboard1.js')}}"></script>
</body>
